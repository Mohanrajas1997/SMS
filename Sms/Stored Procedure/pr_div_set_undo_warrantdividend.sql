...
drop procedure if exists pr_div_set_undo_warrantdividend$$

CREATE PROCEDURE pr_div_set_undo_warrantdividend(
...
me:BEGIN
  ...
  set out_msg = concat('Out of ',cast(n as char),' record(s) ',cast(n-c as char),' undo made warrantfully !');
  set out_result = 1;
END $$
