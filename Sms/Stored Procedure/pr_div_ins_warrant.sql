...
DROP PROCEDURE IF EXISTS pr_div_ins_warrant $$
CREATE PROCEDURE pr_div_ins_warrant(
  in in_file_gid int,
...
me:BEGIN
 ...
 -- duplicate checking
  ...
  insert into div_trn_twarrant
  (file_gid,folio_no,acc_no,ben_name,warrant_date,warrant_no,chq_date,chq_no,warrant_amount,batch_no) values
  (in_file_gid,in_folio_no,in_acc_no,in_ben_name,in_warrant_date,in_warrant_no,in_chq_date,in_chq_no,
  in_warrant_amount,in_batch_no);
