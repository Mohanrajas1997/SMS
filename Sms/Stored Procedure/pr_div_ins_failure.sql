...
DROP PROCEDURE IF EXISTS pr_div_ins_failure $$
CREATE PROCEDURE pr_div_ins_failure(
  in in_file_gid int,
  ...
  in in_failure_remark varchar(255),
  in in_line_no int,
...
me:BEGIN
  ...
  insert into div_trn_tfailure
  (file_gid,folio_no,acc_no,ben_name,div_amount,share_count,share_value,val_date,pay_mode,ben_acc_no,
  ben_ifsc_code,ben_add1,ben_add2,ben_add3,ben_add4,ben_city,ben_pincode,ben_email_id,ref_no,warrant_no,failure_remark) values
  ...
  in_ref_no,in_warrant_no,in_failure_remark);
