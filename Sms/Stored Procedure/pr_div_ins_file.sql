...
DROP PROCEDURE IF EXISTS pr_div_ins_file $$
CREATE PROCEDURE pr_div_ins_file(
...
me:BEGIN
 ...
 -- duplicate checking
  ...
  INSERT INTO div_trn_tfile(file_name,sheet_name,file_type,insert_date,insert_by)
  VALUES(in_file_name,in_sheet_name,in_file_type,sysdate(),in_action_by);
